...
public class EsferaUsuario extends JFrame implements ActionListener {
	private Container contenedor;private JLabel radio,volumen,superficie;private JTextField campoRadio; private JButton calcular;
	
	public EsferaUsuario() {
		inicio();
		setTitle("Esfera");
		setSize(280,200);
