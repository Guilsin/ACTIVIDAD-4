...
public class CilindroUsuario extends JFrame implements ActionListener {
	
private Container contenedor;private JLabel radio, altura, volumen, superficie;private JTextField campoRadio, campoAltura;private JButton calcular;	
	public CilindroUsuario() {
	inicio();
	setTitle("Cilindro"); 
	setSize(280,210); 
	...
	private void inicio() {
		...
		error = true;
			...
			if(error) {
				JOptionPane.showMessageDialog(null,"Campo nulo oerror en formato de numero",
